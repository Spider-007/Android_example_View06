 ...
 * For example, you can add them to a new file called <code>res/xml/file_paths.xml.xml</code>.
 ...
 * to <code>&#64;xml/file_paths.xml</code> (notice that you don't specify the <code>.xml</code>
 ...
 *        android:resource="&#64;xml/file_paths.xml" /&gt;
 * &lt;/provider&gt;
 * </pre>
...
public class FileProviderSourceCode extends ContentProvider {
